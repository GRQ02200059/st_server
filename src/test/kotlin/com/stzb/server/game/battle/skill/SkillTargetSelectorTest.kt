...
class SkillTargetSelectorTest {
    ...
    fun `detail marker conditions filter each candidate independently`() {
        ...
        runtime.recordMarker(enemyBase, 21002401, value = 0, appliedRound = 0, durationRounds = 2)
        assertEquals(
            listOf(enemyBase),
            select(rule(selectType = 34, castCondition = 121002401), context),
        )
        runtime.recordMarker(enemyFront, 20000301, value = 0, appliedRound = 0, durationRounds = 2)
        assertEquals(
            listOf(enemyFront),
            select(rule(selectType = 34, castCondition = 320000301), context),
        )
        runtime.recordMarker(enemyMiddle, 20024301, value = 100, appliedRound = 0, durationRounds = 2)
        runtime.recordMarker(enemyBase, 20024302, value = 100, appliedRound = 0, durationRounds = 2)
        assertEquals(
            listOf(enemyFront, enemyBase),
            select(rule(selectType = 34, castCondition = 420024301), context),
        )
        assertEquals(
            listOf(enemyFront, enemyMiddle),
        ...
        runtime.recordMarker(enemyFront, 21024601, 0, appliedRound = 1, durationRounds = 1)
        runtime.recordMarker(enemyMiddle, 20024601, 0, appliedRound = 1, durationRounds = 1)
        runtime.recordMarker(enemyBase, 21324601, 0, appliedRound = 1, durationRounds = 1)
        assertEquals(
            listOf(enemyFront),
            select(rule(selectType = 34, castCondition = 321024601), context),
        )
        assertEquals(
            listOf(enemyMiddle),
            select(rule(selectType = 34, castCondition = 320024601), context),
        )
        assertEquals(
            listOf(enemyBase),
            select(rule(selectType = 34, castCondition = 321324601), context),
        )
        runtime.recordMarker(enemyMiddle, 20025101, 0, appliedRound = 1, durationRounds = 1)
        runtime.recordMarker(enemyFront, 21525101, 0, appliedRound = 1, durationRounds = 1)
        assertEquals(
            listOf(enemyMiddle),
            select(rule(selectType = 34, castCondition = 320025101), context),
        )
        assertEquals(
            listOf(enemyFront),
            select(rule(selectType = 34, castCondition = 321525101), context),
        )
        runtime.recordMarker(enemyMiddle, 21226402, 0, appliedRound = 1, durationRounds = 8)
        runtime.recordMarker(enemyBase, 21126401, 0, appliedRound = 1, durationRounds = 8)
        assertEquals(
            listOf(enemyMiddle),
            select(rule(selectType = 34, castCondition = 321226402), context),
        )
        assertEquals(
            listOf(enemyBase),
            select(rule(selectType = 34, castCondition = 321126401), context),
        )
        runtime.recordMarker(enemyFront, 21125401, 0, appliedRound = 1, durationRounds = 8)
        assertEquals(
            listOf(enemyFront),
            select(rule(selectType = 34, castCondition = 321125401), context),
        )
        runtime.recordMarker(enemyMiddle, 21025601, 0, appliedRound = 1, durationRounds = 8)
        assertEquals(
            listOf(enemyMiddle),
            select(rule(selectType = 34, castCondition = 321025601), context),
        )
    }
