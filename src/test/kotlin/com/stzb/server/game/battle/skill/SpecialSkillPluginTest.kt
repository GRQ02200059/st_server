    ...
    fun `coverage reports exact fail closed condition plugin debt without duplicate execution`() {
        ...
        val resolvedTargetCodes = ScopedConditionCodeCatalog.codes.filterTo(linkedSetOf()) {
            it.field == SkillConditionField.PRECONDITION &&
                ...
                it.field == SkillConditionField.CAST_CONDITION &&
                it.value in setOf(500, 4000, 7001) ||
                it.field == SkillConditionField.CONDITION &&
                ...
                it == SkillConditionCode(200275, SkillConditionField.CONDITION, 5009) ||
                it == SkillConditionCode(200277, SkillConditionField.CONDITION, 5006) ||
                ...
                it == SkillConditionCode(200008, SkillConditionField.CONDITION, 26636) ||
                it == SkillConditionCode(
                    200268,
                    SkillConditionField.CAST_CONDITION,
                    420026822,
                ) ||
                it == SkillConditionCode(210270, SkillConditionField.CONDITION, 15002) ||
                ...
                it == SkillConditionCode(200293, SkillConditionField.CONDITION, 5001) ||
                it == SkillConditionCode(201006, SkillConditionField.CONDITION, 24001) ||
                it == SkillConditionCode(200961, SkillConditionField.CONDITION, 5005) ||
