...
class LegacySkillCatalogTest {
    ...
    @Test
    fun `lianzhan applies double attack to self`() {
    ...
    @Test
    fun `xianqu applies first action double attack and attack bonus`() {
        ...
        val cast = runtime.tryAct(
            ...
            random = FixedBattleRandom(0),
            state = SkillRuntimeState(),
            allowedKinds = setOf(SkillKind.COMMAND),
        )
    ...
    @Test
    fun `qijirufeng buffs speed and double attack for every ally`() {
