...
object Cmd {
    ...
    const val PHONE_BIND_SEND_VERIFY_CODE = 331
    const val PHONE_BIND_CHECK_VERIFY_CODE = 332
    const val PHONE_UNBIND = 336
    ...
    const val UNION_MEMBER_CLAN_LIST = 2670
    const val CLAN_SEARCH_CLAN_LIST = 2675
    ...
    const val CHAT_GET_FIGHT_AREA_CHAT = 724
    ...
    const val FAMILY_PRAY_RESULT_LIST = 4092
    const val GET_FIELD_RES_TOTAL_STORE = 4102
    const val FAMILY_MINI_GAME_GET_SCORE_LIST = 4112
    const val FAMILY_MINI_GAME_GET_ROOM_LIST = 4114
    ...
    const val QUERY_OTHER_REGION_CLAN_LIST = 5096
    const val SUMMER_FARM_GET_USER_LIST = 5109
    const val SUMMER_FARM_MESSAGE_RECORD = 5120
    const val SUMMER_FARM_VISIT_RECORD = 5121
    const val ANNIVERSARY_COMPETITION_FOR_LOG = 5202
    const val GET_HERO_RECOMMEND_2 = 5210
    const val NOBILITY_TITLE_QUERY_EIGHT_OFFICER_RECORD = 5212
    const val GET_USER_RES_WID_LEVEL_MAP = 5218
    ...
    const val CHAT_UNION_PLAN_HISTORY = 6054
    ...
    const val QUERY_USER_MARKET_SCORE = 6089
    ...
    const val PRE_SERVER_QUERY_S2_RETRUN_ROLE_INFO = 40006
    const val PRE_SERVER_QUERY_ADVERTISEMENT_SIGN = 40007
    const val GET_PREBOOK_SERVER_INFO = 40008
    const val GET_CHANNEL_TRANSFER_TOKEN = 40014
