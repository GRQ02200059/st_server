        ...
        listOf(
            ...
            listOf(
                ...
                provisionalRequest(Cmd.CLAN_APPLICANT_LIST)
                    .copy(domain = CommandDomain.SOCIAL),
                provisionalRequest(Cmd.CLAN_NEARBY_NEARBY_PLAYER_LIST)
                    .copy(domain = CommandDomain.SOCIAL),
                ...
                provisionalRequest(Cmd.UNION_APPLICANT_LIST)
                    .copy(domain = CommandDomain.SOCIAL),
                provisionalClientRequest(Cmd.CHAT_GET_CITY_HISTORY)
                    .copy(domain = CommandDomain.SOCIAL),
                ...
                provisionalClientRequest(Cmd.CHAT_GET_SAND_TABLE_ROOM_MSG)
                    .copy(domain = CommandDomain.SOCIAL),
                provisionalRequest(Cmd.INVITATIONAL_QUERY_LOG)
                    .copy(domain = CommandDomain.SOCIAL),
                provisionalRequest(Cmd.GET_MILITARY_STRATEGY_UNION_LOG)
                    .copy(domain = CommandDomain.SOCIAL),
                provisionalClientRequest(Cmd.FAMILY_LOG_GET)
                    .copy(domain = CommandDomain.SOCIAL),
